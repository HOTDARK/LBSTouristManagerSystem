...
var KisBpmStringPropertyCtrl = [ '$scope', function ($scope) {
    ...
    $scope.inputBlurred = function() {
        ...
        //整个流程
        if($scope.selectedShape.getParents().length==0){
        	var meta = $scope.editor.getModelMetaData();
        	switch($scope.property.key){
        		case "oryx-name":
        			meta.name = $scope.property.value;
        			break;
        		case "oryx-process_id":
        			meta.processId = $scope.property.value;
        			break;
        	}
