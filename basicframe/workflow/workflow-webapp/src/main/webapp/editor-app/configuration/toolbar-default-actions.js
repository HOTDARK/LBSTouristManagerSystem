...
var SaveModelCtrl = [ '$rootScope', '$scope', '$http', '$route', '$location',
    ...
    var saveDialog = { 
    		...
    		'processId': modelMetaData.processId,
    ...
    $scope.save = function (successCallback) {
        ...
        modelMetaData.processId = $scope.saveDialog.processId;

        $scope.updatePropertyInModel({key:"oryx-name" , value:modelMetaData.name});
        $scope.updatePropertyInModel({key:"oryx-process_id",value:modelMetaData.processId});
        $scope.safeApply();
        ...
        var params = {
            ...
            process_id:modelMetaData.processId?modelMetaData.processId:""
        };
