...
//	public List<OverTimeSetting> getAllTimeSetting();
	 ...
	 * @throws Exception
	 */
	public List<SysUser> findByCompanyCode(@Param("companyCode")String companyCode) throws Exception;

	public SysUser findByTelphone(@Param("telphone")String telphone);
}
