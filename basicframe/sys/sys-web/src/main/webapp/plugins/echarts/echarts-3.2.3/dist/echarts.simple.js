...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var GlobalModel = Model.extend({
	         ...
	         * @param {Object} [condition.query] like {hdIndex, hdId, hdName},
	         *        where hd is mainType.
	         ...
	         *     // (componentType is 'hd' but not 'hd.aa')
	         * });
	         * eachComponent(
	         *     {mainType: 'dataZoom', query: {dataZoomId: 'abc'}},
	         *     function (model, index) {...}
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    clazz.enableClassManagement = function (entity, options) {
	         ...
	         * key: componentType,
	         * value:
	         *     componentClass, when componentType is 'hd'
	         *     or Object.<subKey, componentClass>, when componentType is 'hd.yy'
	         * @type {Object}
	         */
	        var storage = {};
	 ...
	 // TODO getTotalLength, getPointAtLength
	    ...
	    PathProxy.prototype = {
	        ...
	        moveTo: function (x, y) {
	            ...
	            // x0, y0, xi, yi 是记录在 _dashedhdXTo 方法中使用
