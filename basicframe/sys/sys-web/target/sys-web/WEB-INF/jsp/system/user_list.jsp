...
<body>
    ...
    <div class="row innter-content">
    	<div class="ptool-bar" >
	  		<span class="btn darkblue" onclick="addUser();"><i class="fa fa-plus"></i><spring:message code="sys.user.addUser"/></span>
	        <span class="btn green" onclick="updateUserState('1');"><i class="fa fa-gavel"></i><spring:message code="sys.user.activateUser"/></span>
	        <span class="btn yellow" onclick="updateUserState('0');"><i class="fa fa-ban"></i><spring:message code="sys.user.frozenUser"/></span>
		</div>
		<div class="col-md-12" >
			<form id="searchForm" class="form-inline search-bar" onsubmit="return false">
				...
				<div class="col-md-12" >
					<input type="text" class="form-control" style="width:120px; float:left; margin-left:2px;" id="searchUserName" name="userName" placeholder="用户姓名" >
		       		<input type="text"class="form-control" style="width:120px; float:left;  margin-left:2px;margin-right:2px;" id="searchTelephone" name="telephone" placeholder="联系电话">
		    		<select class="selectpicker form-control" data-width="120px" id="searchState" name="state">
		  			...
		  			<div class="btn blue" onclick="userListSearch();">
