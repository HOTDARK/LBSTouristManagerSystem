...
node.style.textAlign='left';if(tp==TEXTBOX){node.innerHTML=["<input type='text' class='",cssName,"'  value='",value,"' name='",inputName,"' ",setDisabled," userSetDisabled='",setDisabled,"'/>"].join('');}else if(tp==HTML){texts=showTypeDesc.htmlStr;node.setAttribute('id',inputName);node.innerHTML=texts.replace(/[$]/g,value);}
...
if(tc.noparentImg==null){tc.noparentImg='../images/leaf.png';}
