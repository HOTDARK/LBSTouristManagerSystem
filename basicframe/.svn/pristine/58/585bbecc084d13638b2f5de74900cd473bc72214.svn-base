...
<body>
	...
	<script src="editor-app/configuration/properties-subprocess-reference-controller.js" type="text/javascript"></script>
	<script src="editor-app/configuration/properties-conclusion-controller.js" type="text/javascript"></script>
