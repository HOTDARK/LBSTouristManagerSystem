...
<div class="row innter-content">
    <%--<div class="ptool-bar">
        ...
        &lt;%&ndash;<span class="btn yellow" onclick="updateUserState('0');"><i class="fa fa-ban"></i><spring:message
                code="sys.user.frozenUser"/></span>&ndash;%&gt;
        ...
        <form id="searchForm" class="form-inline search-bar" onsubmit="return false">
            ...
            <div class="col-md-12">
                ...
                <select class="selectpicker form-control" data-width="120px" id="searchState" name="state">
                    ...
                    <option value="1" selected="selected"><spring:message code="public.select.effective"/></option>
                </select>
