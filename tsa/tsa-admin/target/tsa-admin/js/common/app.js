...
var App = function () {
    ...
    var handleResponsiveOnResize = function () {
        ...
        if (isIE8) {
			...
			//if($(".page-content").height()<$(window).height()-160)
			//$(".page-content").height($(window).height()-160);
    ...
    var handleTheme = function () {
        ...
        var setLayout = function () {
            ...
            if (sidebarOption == "fixed" && headerOption == "default") {
                alert('默认头部不支持固定菜单，请设置固定头部后在固定菜单');/*Default Header with Fixed Sidebar option is not supported. Proceed with Fixed Header with Fixed Sidebar.*/
                $('.header-option', panel).val("fixed");
