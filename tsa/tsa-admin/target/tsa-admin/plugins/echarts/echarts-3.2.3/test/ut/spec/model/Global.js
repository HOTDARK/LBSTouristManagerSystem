    ...
    describe('idSpecified', function () {
        ...
        testCase.createChart()('nameTheSameButIdNotTheSame', function () {
            ...
            var option = {
                grid: {},
                xAxis: [
                    {id: 'x1', name: 'a', hdx: 'x1_a'},
                    {id: 'x2', name: 'b', hdx: 'x2_b'}
                ],
                yAxis: {}
            };
            ...
            expect(xAxisModel0.option.hdx).toEqual('x1_a');
            expect(xAxisModel1.option.hdx).toEqual('x2_b');
            expect(xAxisModel1.option.name).toEqual('b');

            var option2 = {
                xAxis: [
                    {id: 'k1', name: 'a', hdx: 'k1_a'},
                    {id: 'x2', name: 'a', hdx: 'x2_a'}
                ]
            };
            chart.setOption(option2);
            ...
            expect(xAxisModel0.option.hdx).toEqual('x1_a');
            expect(xAxisModel1.option.hdx).toEqual('x2_a');
            expect(xAxisModel1.option.name).toEqual('a');
            expect(xAxisModel2.option.hdx).toEqual('k1_a');
        });
