 ...
 * @date	2017-11-13
 */
public class WxActivityInfo extends Pagination<WebAdInfo> {
	...
	public String getActivityPositionName() {
		return activityPositionName;
	}

	public void setActivityPositionName(String activityPositionName) {
		this.activityPositionName = activityPositionName;
	}
