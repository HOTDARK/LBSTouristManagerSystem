...
<script type="text/javascript" src="js/web/ad.js"></script>
</head>
<body>
	<div class="row">
		<div class=" col-md-12">
	    	<div class="ptool-bar" >
	  		<a href="javascript:void(0);" class="btn darkblue" id="webAdAdd" onclick="editAdInfo()"><i class="fa fa-plus"></i><spring:message code="public.txt.add"/></a>
	  	 </div>
	  	</div>
	...
	<div id="editWebAdInfoDiv" style="display: none;"></div>
</body>
</html>