 ...
 * @date	2017-11-15
 */
public class LearnOrder extends BaseModel{
	...
	public void setRealStartTimeBegin(java.util.Date value) {
		this.realStartTimeBegin = value;
	}
	
	public java.util.Date getRealStartTimeBegin() {
		return this.realStartTimeBegin;
	}
	public void setRealStartTimeEnd(java.util.Date value) {
		this.realStartTimeEnd = value;
	}
	
	public java.util.Date getRealStartTimeEnd() {
		return this.realStartTimeEnd;
	}
	public void setRealStartTime(java.util.Date value) {
	...
	public void setRealEndTimeBegin(java.util.Date value) {
		this.realEndTimeBegin = value;
	}
	
	public java.util.Date getRealEndTimeBegin() {
		return this.realEndTimeBegin;
	}
	public void setRealEndTimeEnd(java.util.Date value) {
		this.realEndTimeEnd = value;
	}
	
	public java.util.Date getRealEndTimeEnd() {
		return this.realEndTimeEnd;
	}
	public void setRealEndTime(java.util.Date value) {
		this.realEndTime = value;
	}
	
	public java.util.Date getRealEndTime() {
		return this.realEndTime;
	}
	public void setRealStuTime(java.lang.Integer value) {
		this.realStuTime = value;
	}
	
	public java.lang.Integer getRealStuTime() {
		return this.realStuTime;
	}
