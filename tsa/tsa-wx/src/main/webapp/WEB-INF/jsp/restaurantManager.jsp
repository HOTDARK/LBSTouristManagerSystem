...
<div class="weui-tab">
	<div class="weui-navbar ft18 ft-bold400 ordering-tab">
		<a class="weui-navbar__item" href="javascript:;" id="anchor1" onclick="anchor(1)">
		  未处理订单
		</a>
		<a class="weui-navbar__item" href="javascript:;" id="anchor2" onclick="anchor(2)">
		  已处理订单
		</a>
		<a class="weui-navbar__item weui-bar__item--on" href="javascript:;" id="anchor3" onclick="anchor(3)">
		  餐厅管理
		</a>
	</div>
	<div class="weui-tab__bd">
		...
		<!--tab 已处理订单-->
		<div id="tab2" class="reset-weui-cells weui-tab__bd-item" style="width:100%;">
		...
		<div id="tab3" class="weui-tab__bd-item  weui-tab__bd-item--active">
			...
			<!--捆绑成功-->
			<div class="weui-cells mar-t6" id="sourceK" style="display: none"></div>
		</div>
	</div>
</div>
