...
<body ontouchstart class="bg-grey-eee">
	...
	<div class="weui-cells bg-white">
		...
		<div class="weui-cell line-d1e">
			...
			<div class="weui-cell__bd">
			  <p><input class="weui-input" type="tel" placeholder="手机号" id="bindUserPhone"></p>
			</div>
    ...
    <p class="weui-btn-area">
      <a href="javascript:void(0)" class="weui-btn bg-deep-blue" onclick="bindPhone(this)">绑   定</a>
      <a href="javascript:void(0)" onclick="jumpPage('wx/jumpPage.action?viewName=userRegister.jsp')" class="weui-btn weui-btn_default ft14"><span class="ft-grey-999">亲，还没账号请</span> <span class="ft-blue">注册</span></a>
    </p>
  </div>
	<!--temp-->
...
<script type="text/javascript" src="js/wx.userBind.js"></script>
</body>
</html>
