...
<div class="weui-navbar ft18 ft-bold400 set-box">
		<a href="javascript:void(0)" type="button" class="bg-deep-blue ft14" onclick="audit(this,0)" id="auditBtn">审核通过</a>
		<a href="javascript:void(0)" type="button" class="bg-deep-blue ft14" onclick="audit(this,1)" id="rejectBtn">驳回</a>
</div>
...
<div class="weui-tab">
	<div class="weui-tab__bd">
		<div class="weui-cells bg-white mar-t6 set-box-list" style="margin-top:60px;">
			...
			<div class="weui-cell line-d1e">
							<div class="weui-cell__bd">
								<textarea class="weui-textarea" placeholder="请输入处理意见" rows="3" maxlength="20"  id="yijian"></textarea>
							</div>
						</div>
			<p>&nbsp;</p>
				<!--return-->
...
<script type="text/javascript" src="js/maintainBack.js"></script>
</div>
</body>
</html>