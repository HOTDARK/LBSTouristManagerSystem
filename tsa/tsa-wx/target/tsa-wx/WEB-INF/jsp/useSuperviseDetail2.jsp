...
<title>
	<c:choose>
		<c:when test="${entity.type==0}">服务监督-投诉处理</c:when>
		<c:when test="${entity.type==1}">服务监督-建议处理</c:when>
	</c:choose>
</title>
    <meta charset="utf-8">
...
<div class="weui-navbar ft18 ft-bold400 set-box">
	...
	<a href="javascript:void(0)" type="button" class="bg-deep-blue ft14" onclick="feedback(this)" id="adopt" style="display:none;">提交</a>
</div>
	...
	<div class="weui-tab__bd">
		<div class="weui-cells bg-white mar-t6 set-box-list" style="margin-top:60px;">
			<div class="center-text hei-36 line-hei36 ft-grey-999 line-d1e">
				...
				<span class="ft-bold400">投诉详情</span>
				<span class="line-mid" >&nbsp;&nbsp;</span>
			</div>
			...
			<div class="weui-cell line-d1e">
				...
				<div class="weui-cell__bd">
					<textarea class="weui-textarea" placeholder="处理意见" rows="3"
						id="feedback" onchange="changeCauseNum(this)" maxlength="198">${entity.feedback }</textarea>
